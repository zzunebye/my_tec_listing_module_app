...
import 'package:my_tec_listing_module_app/data/api/booking_api_service.dart';
...
class CityListState extends _$CityListState {
  ...
  FutureOr<List<CityDto>> build() async {
    ref.keepAlive();
    final bookingApiService = ref.read(bookingApiServiceProvider);
    final GetCitiesResponseDto cities = await bookingApiService.getCities(pageSize: 50);
